...
public class Calc_Lib {
	...
	/**
	 * VypoÄ�Ã­tÃ¡ smÄ›rodatnou odchylku z hodnot, kterÃ© se nachÃ¡zejÃ­ v souboru zadanÃ©m cestou 'filename'. <br>
	 * ÄŒÃ­sla uvnitÅ™ souboru jsou ve fromÃ¡tu: cislo1 'whitespace chars' cislo2' whitespace chars'... cislo n <br>
	 * SmÄ›rodatnou odchylku poÄ�Ã­tÃ¡ podle vzoreÄ�ku: ((suma(od i=0 do n)(xi - Xprumer)^2)/(n-1))^0.5 <br>
	 * @param filename - Cesta k souboru s Ä�Ã­sly
	 * @return hodnota smÄ›rodatnÃ© odchylky
	 * @throws Exception
	 */
    ...
    {
        Scanner sc = new Scanner(new File("st_Dev100000.txt"));
    ...
    public static void STDEV1000000()
    {
        try
        {
            Calc_Lib.st_Dev("st_Dev1000000.txt");
        }
        catch(Exception e)
        {
    ...
    public static void STDEV100000()
    {
        try
        {
            Calc_Lib.st_Dev("st_Dev100000.txt");
        }
        catch(Exception e)
        {
            System.out.print(e.getMessage());
