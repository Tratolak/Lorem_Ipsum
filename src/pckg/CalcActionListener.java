...
public class CalcActionListener extends AbstractAction{
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	{
    		final String napoveda = "<html> <h2>Funkce kalckulačky: </h2> <table> <tr> <td> Operace: </td> <td> Znak</td> <td> Podmínky: </td> </tr> <tr> <td>sčítání</td> <td>+</td> <td>---</td> </tr> <tr> <td>odčítání</td> <td>-</td> <td>---</td> </tr> <tr> <td>násobení</td> <td>*</td> <td>---</td> </tr> <tr> <td>dělení</td> <td>/</td> <td>Nelze dělit nulou.</td> </tr> <tr> <td>n-tá mocnina</td> <td>x<sup>n</sup></td> <td>---</td> </tr> <tr> <td>druhá mocnina</td> <td>x<sup>2</sup></td> <td>---</td> </tr> <tr> <td>druhá odmocnina</td> <td>&radic;x</td> <td>Nelze vypočítat odmocninu se záporného čísla.</td> </tr> <tr> <td>n-tá odmocnina</td> <td> <sup>n</sup>&radic;x</td> <td>Nelze vypočítat odmocninu se záporného čísla.</td> </tr> <tr> <td>směrodatná odcdylka</td> <td><font face='Symbol'>s</font></td> <td>Při neplatném souboru se výpočet neprovede.</td> <tr> <td>faktoriál</td> <td>!</td> <td>Nelze vypočítat faktoriál se záporného čísla.</td> </tr> <tr> <td>mazaníjednoho znaku</td> <td>del</td> <td>---</td> </tr> <tr> <td>nulování kalkulačky</td> <td>C</td> <td>---</td> </tr> </table> <p> Při výpočtu je výraz hodnocen z leva do prava -> nejsou upřednostněny operace násobení, dělení, faktoriál, mocnina a odmocnina před sčítáním a odčítáním. </p> <p>Zadaný výraz je vyhodnocen až po kliknutí na tlačítko '=', případně po zmáčknutí klávesy ENTER.</p> </html>";
